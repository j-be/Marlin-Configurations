...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro v2.1.2 (VoronM4)"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 28.263
    #define DEFAULT_Ki 2.420
    #define DEFAULT_Kd 82.5287
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Creality Ender-3 Pro
  #define DEFAULT_bedKp 74.24
  #define DEFAULT_bedKi 14.73
  #define DEFAULT_bedKd 249.44
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 565 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -5, -1.5 }
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { { 2, -5, 3 } }
  #define NOZZLE_CLEAN_END_POINT   { { 50, -26, 3 } }
  ...
  #define WIPE_SEQUENCE_COMMANDS "G1 X10 Y0\n G1 Y-15\nG1 X45\nG1 Y-10\nG1 X2"
